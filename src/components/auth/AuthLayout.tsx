...
export function AuthLayout({ children }: AuthLayoutProps) {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-gradient-to-br from-white to-femme-pink-light relative overflow-hidden">
      <BackgroundPattern />
      <div className="w-full max-w-md mb-6 relative z-10">
        <Logo className="mx-auto" />
        <h2 className="text-center text-femme-gray mt-2 text-sm font-medium flex items-center justify-center gap-2">
          <Flower size={16} className="text-femme-burgundy opacity-70" />
          Your personal cycle companion
          <Heart size={16} className="text-femme-burgundy opacity-70" />
        </h2>
      </div>
